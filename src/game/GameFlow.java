...
public class GameFlow {
     ...
     * Open menu.
     *
     * @param setFile set file
     */
    public void openMenu(Reader setFile) {
        Menu<Task<Void>> menu = new MenuAnimation<Task<Void>>("ARKNOID", keyboard, runner);
        LevelSet levelSet = new LevelSet(keyboard, runner, frameWidth, frameHeight, highScoresTable, scoresFile);

        // sub menu
        Menu<Task<Void>> subMenu = levelSet.setLevels(setFile);
