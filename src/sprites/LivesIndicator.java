...
public class LivesIndicator implements Sprite, HitListener {
    ...
    private Counter numOfBallsLeft;
     ...
     * @param numOfBalls number of balls left in the game
     * @param value      number of lives remained in the game
     */
    public LivesIndicator(Rectangle rectangle, Counter numOfBalls, Counter value) {
        this.shape = rectangle;
        this.numOfBallsLeft = numOfBalls;
